...
ffmpeg_path = os.path.join(base_dir, "binaries", "ffmpeg-win64-v4.2.2.exe")
...
def download_audio_as_mp3(url, folder, name):
    ydl_opts = {
...
def download(url, folder, name, artists, album):
    try:
        download_audio_as_mp3(url, folder, name)
